...
# Define a route for company sign-up
...
def company_signup():
    if request.method == 'POST':
        ...
        insert_sql = "INSERT INTO company (company_name, industry, total_staff, product_service, company_website, nature_of_job, ot_claim, company_address, state, remarks, person_in_charge, contact_number, email) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
        cursor = db_conn.cursor()

        try:
            cursor.execute(insert_sql, (
            company_name, industry, total_staff, product_service, company_website, nature_of_job, ot_claim, company_address, state, remarks, person_in_charge, contact_number, email))
            db_conn.commit()
